-- =============================================================================
-- Handover migration 023/100
-- Original: supabase/migrations/20260322120000_doctor_pet_owner_invite_qr.sql
-- Purpose: Allow doctors (same as receptionists) to create pet_owner invite QRs from mobile / API.
