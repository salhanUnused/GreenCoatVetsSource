-- =============================================================================
-- Handover migration 004/100
-- Original: supabase/migrations/20260320233000_atomic_cart_order_rpc.sql
-- Purpose: Adds cart-checkout RPC that converts a cart into an order in one transaction.
