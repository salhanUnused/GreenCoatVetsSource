      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-10 flex flex-col gap-4 sm:mb-12 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-3">
            ...
            <h2 className="font-headline text-3xl font-extrabold text-on-surface sm:text-4xl">{heading}</h2>
            <p className="max-w-2xl text-lg leading-relaxed text-on-surface-variant">{body}</p>
          </div>
          <Link
            href="/team"
