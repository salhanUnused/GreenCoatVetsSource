...
/** Canvas signature pad for portal walk-in desk forms. */
export function ConsentSignatureField({
  name = "consent_signature_png",
  required = true,
  label = "Owner signature",
  hint = "Ask the owner to sign. Required for compliance.",
}: {
  name?: string;
  required?: boolean;
  label?: string;
  ...
  return (
    <div className="space-y-2">
      ...
      <canvas
        ...
        width={560}
        height={160}
        className="h-32 w-full touch-none rounded-xl border border-outline-variant/40 bg-white"
        onPointerDown={(e) => {
