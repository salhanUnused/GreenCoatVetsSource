-- =============================================================================
-- Handover migration 095/100
-- Original: supabase/migrations/20260618170000_staff_profile_senior_doctor.sql
-- Purpose: Allow senior_doctor rows to use update_my_staff_profile (mobile staff profile screen).
